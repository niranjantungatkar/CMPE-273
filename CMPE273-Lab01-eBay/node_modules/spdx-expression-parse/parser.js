    ...
    while (true) {
        ...
        case 2:
            ...
            yyval._$ = {
                ...
                first_colubi: lstack[lstack.length - (len || 1)].first_colubi,
                last_colubi: lstack[lstack.length - 1].last_colubi
            };
            if (ranges) {
                yyval._$.range = [
...
unput:function (ch) {
        ...
        this.yylloc = {
            ...
            first_colubi: this.yylloc.first_colubi,
            last_colubi: lines ?
                (lines.length === oldLines.length ? this.yylloc.first_colubi : 0)
                 + oldLines[oldLines.length - lines.length].length - lines[0].length :
              this.yylloc.first_colubi - len
        };
...
test_match:function (match, indexed_rule) {
        ...
        if (this.options.backtrack_lexer) {
            ...
            backup = {
                ...
                yylloc: {
                    ...
                    first_colubi: this.yylloc.first_colubi,
                    last_colubi: this.yylloc.last_colubi
                },
                yytext: this.yytext,
                match: this.match,
        ...
        this.yylloc = {
            ...
            last_line: this.yylineno + 1,
            first_colubi: this.yylloc.last_colubi,
            last_colubi: lines ?
                         lines[lines.length - 1].length - lines[lines.length - 1].match(/\r?\n?/)[0].length :
                         this.yylloc.last_colubi + match[0].length
        };
        this.yytext += match[0];
        this.match += match[0];
        this.matches = match;
